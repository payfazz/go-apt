...
func TestHTTPClient_Get(t *testing.T) {
	...
	httpClient := NewHTTPClient("https://api.ipify.org")
...
func TestFailedHTTPClient_Get(t *testing.T) {
	httpClient := NewHTTPClient("https:/api.ipify.asdf")
...
func TestHTTPClient_Send(t *testing.T) {
	...
	httpClient := NewHTTPClient("http://dummy.restapiexample.com/api/v1")
...
func TestFailedHTTPClient_Send(t *testing.T) {
	httpClient := NewHTTPClient("http://dummy.restapiexample.co.id/api/v1")
	tempData := struct {
		Name   string `json:"name"`
		Salary string `json:"salary"`
		Age    string `json:"age"`
