...
const (
	...
	OP_IN                 Operator = "IN"
	OP_JSON_GET           Operator = "->"
	OP_JSON_GET_TEXT      Operator = "->>"
	OP_JSON_GET_PATH      Operator = "#>"
	OP_JSON_GET_PATH_TEXT Operator = "#>>"
	OP_JSONB_CONTAIN      Operator = "@>"
	OP_JSONB_IN           Operator = "<@"
	OP_JSONB_HAS          Operator = "?"
	OP_JSONB_HAS_ANY      Operator = "?|"
	OP_JSONB_HAS_ALL      Operator = "?&"
)
